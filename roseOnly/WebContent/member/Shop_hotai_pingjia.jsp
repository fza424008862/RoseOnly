	...
	<body class="skin-blue fixed sidebar-mini" style="height: auto; min-height: 100%;">
		<div class="wrapper" style="height: auto; min-height: 100%;">
			...
			<div class="s_h_sy_right">
				...
				<div style="height: 50px; padding-left: 250px; padding-top: 15px;">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<span style="position:relative; top: 6px;"><img src="img/ri.png" /></span>
					<input type="text" placeholder="起始时间" style="height: 30px;" /> &nbsp;&nbsp;
					<span style="position:relative; top: 6px;"><img src="img/ri.png" /></span>
					<input type="text" placeholder="结束时间" style="height: 30px;" />
					...
					<table>
						...
						<tr>
							...
							<td>
								...
								<div style="margin-top: 22px; width: 100px; height: 50px; margin-left: 210px;"> 张三</div>
							</td>
							<td>美国进口 万多福Wonderful加州开心果</td>
							<td>2019-08-14</td>
							<td>是</td>
