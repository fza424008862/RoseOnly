				...
				<nav class="navbar navbar-static-top">
					...
					<div id="menu" class="navbar-custom-menu">
						<ul class="nav navbar-nav" name="topMenu">
							<li>
								<a hidefocus="true" href="/roseOnly/goods/Shop_hotai_shouye.html">商品</a>
							</li>
							<li>
								<a hidefocus="true" href="/roseOnly/member/Shop_hotai_huiyuan.html">会员</a>
							</li>
							<li>
								<a hidefocus="true" href="/roseOnly/order/dingdan.html">订单</a>
							</li>
							<li>
				...
				<div class="content">
					<form name='right_list' method='post' action='/system/right_update/recycle/del'>
						<table class="table list-table">
							<caption>
								<a class="btn btn-default" href='/roseOnly/permissions/right_edit.jsp'>
							...
							<tbody>
								<c:forEach items="${power }" var="powerList" varStatus="vs">
									<tr>
										<td><input type='checkbox' name='id[]' value='1' /></td>
										<td>${vs.count }</td>
										<td>${powerList.power_name }</td>			
										<td>
											<a href="/roseOnly/PowerServlet?op=updatePower&choose=edit&power_name=${powerList.power_name }"><i class='glyphicon glyphicon-edit'></i></a>
											<a href="/roseOnly/PowerServlet?op=deletePower&power_id=${powerList.power_id }"><i class='glyphicon glyphicon-trash'></i></a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
