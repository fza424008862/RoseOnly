		...
		<script>
			...
			$(function() {
				...
				$("#add_img").click(function(){
					...
					tr.appendTo($("#shuju"));
					var td=$("<td>");
					td.html($("<input>").attr("type", "file").attr("name","myFile"));
					var det=$("<td>");
					det.html($("<a>").css("cursor","pointer").css("text-decoration","none").css("color","white").html("删除").attr("class","dee"));
						...
						<li class="li3">
							...
							<ul class="ul1" id="x">
								<li>
									...
									<a href="Shop_hotai_Type.jsp">分类列表</a>
								</li>
							</ul>
							<ul class="ul1" name="ul3">
								<li>
									...
									<a href="/roseOnly/TypeServlet?op=inputAll&x=shop">添加分类</a>
								</li>
							</ul>
						</li>
					</ul>
				...
				<div class="s_h_sy_right_neirong" id="addxx">
					<form action="/roseOnly/ShopServlet?op=addShop&choose=houtai" enctype="multipart/form-data" method="post" id="bianji">
						<table id="shuju">
							<tr>
								<td>添加的商品名称&nbsp;:</td>
								<td><input type="text" class="addtext" name="shop_name" id="name" style="float: left;"/></td>
								<td></td>
							</tr>
							<tr>
								<td>商品类别&nbsp;:</td>
