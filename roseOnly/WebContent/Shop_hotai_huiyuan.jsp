		...
		<div id="container">
						...
						<li class="li2">
							...
							<ul class="ul1" name="ul2" style="display: block;">
								<li>
									...
									<a href="/roseOnly/UserServlet?op=chaxun">会员列表</a>
								</li>
							</ul>
							<ul class="ul1" name="ul2" style="display: block;">
								<li>
									...
									<a href="Shop_hotai_addHuiyuan.html">添加会员</a>
								</li>
							</ul>
						</li>
						<li class="li3">
							...
							<ul class="ul1" id="x">
								<li>
									...
									<a href="Shop_hotai_pingjia.html">评价管理</a>
								</li>
							</ul>
							<ul class="ul1" name="ul3">
								<li>
									...
									<a href="Shop_hotai_daohuo.html">到货通知</a>
								</li>
							</ul>
						</li>
			...
			<div class="s_h_sy_right">
				...
				<div class="s_h_sy_right_caozuo">
					<a href="Shop_hotai_addHuiyuan.html"><input type="button" value="添加会员" name="add" /></a>
